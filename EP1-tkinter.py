...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 26 14:06:54 2018
...
class ESTOQUE:
    def __init__(self):
        ...
        self.inicia = tki.Button(self.window)
        self.inicia.configure(text = 'Clique aqui para acessar o Sistema de Gerenciamento de Estoques')
        self.inicia.configure(command = self.acessar_estoque)
        self.inicia.grid()
